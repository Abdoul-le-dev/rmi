                ...
                <div class="container my-5">
                    ...
                    <div class="video-player-container" id="videoPlayerContainer">
                        ...
                        <div class="video-player-wrapper">
                            ...
                            <video id="videoPlayerNative" class="video-player-iframe" controls style="display: none;"></video>
                        </div>
                    </div>
                </div>
    ...
    async function fetchLocalVideos() {
        try {
            ...
            return data.map(video => ({
                id: video.id,
                title: video.room_name || video.file_name,
                thumbnail: '{{ asset("images/video-placeholder.jpg") }}', // Image par défaut
    ...
    function generateVideoCards(videos) {
        ...
        if (videos.length === 0) {
            ...
            videos.forEach(video => {
                ...
                const badgeClass = video.source === 'local' ? 'video-badge local' : 'video-badge';
                const badgeText = video.source === 'local' ? 'Local Recording' : 'Recorded Video';
