    ...
    <section class="section">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>{{trans('admin/main.active_subscribed_users')}}</h4>
                        <div class="card-header-action">
                            <a href="{{ route('active_subscribed_users.export') }}" class="btn btn-sm btn-primary">{{ trans('admin/main.export_xls') }}<i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive text-center">
                            <table class="table table-striped font-14">
                                ...
                                @if($sales->isNotEmpty())
                                    @foreach($sales as $sale)
                                        <tr>
                                            <td>{{ $sale->buyer->id }}</td>
                                            <td class="text-left">{{ $sale->buyer->full_name }}</td>
                                            <td>{{ $sale->buyer->email }}</td>
                                            <td>{{ $sale->buyer->mobile }}</td>
                                        </tr>
                                    @endforeach
                                @else
                                    <tr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{ trans('admin/main.users_whose_subscriptions_have_expired') }}</h4>
                            <div class="card-header-action">
                                <a href="{{ route('expired_subscriptions.export') }}" class="btn btn-sm btn-primary">{{ trans('admin/main.export_xls') }}<i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive text-center">
                                <table class="table table-striped font-14">
                                    ...
                                    @if($expired_subscriptions->isNotEmpty())
                                        @foreach($expired_subscriptions as $expired_subscription)
                                            <tr>
                                                <td>{{ $expired_subscription->buyer->id }}</td>
                                                <td class="text-left">{{ $expired_subscription->buyer->full_name }}</td>
                                                <td>{{ $expired_subscription->buyer->email }}</td>
                                                <td>{{ $expired_subscription->buyer->mobile }}</td>
                                            </tr>
                                        @endforeach
                                    @else
                                        <tr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{ trans('admin/main.users_who_have_not_purchased_anything_since_registering') }}</h4>
                            <div class="card-header-action">
                                <a href="{{ route('users_without_sales.export') }}" class="btn btn-sm btn-primary">{{ trans('admin/main.export_xls') }} <i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive text-center">
                                <table class="table table-striped font-14">
                                    ...
                                    @if($usersWithoutSales->isNotEmpty())
                                        @foreach($usersWithoutSales as $usersWithoutSale)
                                            <tr>
                                                <td>{{ $usersWithoutSale->id }}</td>
                                                <td class="text-left">{{ $usersWithoutSale->full_name }}</td>
                                                <td>{{ $usersWithoutSale->email }}</td>
                                                <td>{{ $usersWithoutSale->mobile }}</td>
                                            </tr>
                                        @endforeach
                                    @else
                                        <tr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{ trans('admin/main.people_who_have_purchased_a_course_and_who_have_not_yet_purchased_a_subscription_once') }}</h4>
                            <div class="card-header-action">
                                <a href="{{ route('users_with_webinar_only.export') }}" class="btn btn-sm btn-primary">{{ trans('admin/main.export_xls') }} <i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive text-center">
                                <table class="table table-striped font-14">
                                    ...
                                    @if($usersWithWebinarOnly->isNotEmpty())
                                        @foreach($usersWithWebinarOnly as $userWithWebinarOnly)
                                            <tr>
                                                <td>{{ $userWithWebinarOnly->id }}</td>
                                                <td class="text-left">{{ $userWithWebinarOnly->full_name }}</td>
                                                <td>{{ $userWithWebinarOnly->email }}</td>
                                                <td>{{ $userWithWebinarOnly->mobile }}</td>
                                            </tr>
                                        @endforeach
                                    @else
                                        <tr>
