                ...
                <div class="card-body">
                    <form method="get" class="mb-0">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="input-label">{{ trans('admin/main.mobile') }}</label>
                                    <input type="text" class="form-control" name="mobile" value="{{ request()->get('mobile') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="input-label">{{ trans('admin/main.instructor') }}</label>
                                    <input type="text" class="form-control" name="teacher_name" value="{{ request()->get('teacher_name') }}" placeholder="Type teacher name">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="input-label">{{ trans('admin/main.student') }}</label>
                                    <input type="text" class="form-control" name="student_name" value="{{ request()->get('student_name') }}" placeholder="Type student name">
                                </div>
                            </div>
                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    @foreach($sales as $sale)
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                {{ !empty($sale->buyer) && !empty($sale->buyer->email) ? $sale->buyer->email : 'NA' }}
                                            </td>
                                            <td class="text-left">
                                                {{ !empty($sale->buyer) && !empty($sale->buyer->mobile) ? $sale->buyer->mobile : 'NA' }}
                                            </td>
