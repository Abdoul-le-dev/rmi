    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
            ...
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">{{ $siteGeneralSettings['site_name'] ?? 'RMI Class Demo' }}</h1>
                <h5 class="font-weight-normal text-muted-transparent">fully-featured educational platform</h5>
              </div>
              All rights reserved &copy; <a class="text-light bb" target="_blank" href="/">{{ $siteGeneralSettings['site_name'] ?? 'RMI Class Demo' }}</a>
            </div>
          </div>
            </div>
