            ...
            <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/financial/purchase-model*', false))) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ (request()->is(getAdminPanelUrl('/financial/purchase-model', false))) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/purchase-model">{{ trans('admin/main.purchase_module') }}</a>
                    </li>
                    <li class="{{ (request()->is(getAdminPanelUrl('/financial/purchase-model/new', false))) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/purchase-model/new">{{ trans('admin/main.new_purchase_module') }}</a>
                    </li>
                </ul>
            </li>

            <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/financial/promo*', false)) ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    <i class="fa fa-percent"></i>
                    <span>{{ trans('admin/main.promo') }}</span>
                </a>
                <ul class="dropdown-menu">
                    <li class="{{ request()->is(getAdminPanelUrl('/financial/promo', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/promo">{{ trans('admin/main.list_promo') }}</a>
                    </li>
                    <li class="{{ request()->is(getAdminPanelUrl('/financial/promo/new', false)) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/promo/new">{{ trans('admin/main.new_promo') }}</a>
                    </li>
                </ul>
            </li>
