                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="email" id="email" value="{{ request()->get('email') }}" placeholder="Enter email">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="mobile" id="mobile" value="{{ request()->get('mobile') }}" placeholder="Enter mobile number">
                            </div>
                        </div>
