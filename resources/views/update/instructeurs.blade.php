...
<link rel="shortcut icon" href="update/image/favicon.png" />
                                ...
                                <div class="site-navigation d-flex flex-row">
                                    ...
                                    <div class="site-branding">
                                        <a class="home-link" href="index.html" title="Uniaro" rel="home">
                                            <img id="logo-img" class="img-fluid auto_size" alt="image" width="136" height="45" src="update/image/logo_rmi.png">
                                        </a>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            <div class="page-title-heading">
                                <h2 class="title">Nos Instructeurs</h2>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="ttm-box-col-wrapper col-lg-4 col-sm-6 col-md-4 col-xs-12">
                        ...
                        <div class="featured-imagebox featured-imagebox-team style1">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="update/image/charbel.jpg" alt="image"> 
                            </div>
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
                                    <h3><a href="https://app.rmiclass.net/users/1056/profile">Charbel Yayi</a></h3>
                                </div>
                                <div class="team-position">Trader Indépendant</div>
                                <div class="featured-iconbox ttm-media-link">
                                    <div class="media-block">
                                        <div class="media-btn"><i class="ti ti-sharethis"></i></div>
                    ...
                    <div class="ttm-box-col-wrapper col-lg-4 col-sm-6 col-md-4 col-xs-12">
                        ...
                        <div class="featured-imagebox featured-imagebox-team style1">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="update/image/hugues.jpg" alt="image">
                            </div>
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
                                    <h3><a href="https://app.rmiclass.net/users/1057/profile">Hugues HOUNSA</a></h3>
                                </div>
                                <div class="team-position">Trader Indépendant</div>
                                <div class="featured-iconbox ttm-media-link">
                                    <div class="media-block">
                    ...
                    <div class="ttm-box-col-wrapper col-lg-4 col-sm-6 col-md-4 col-xs-12">
                        ...
                        <div class="featured-imagebox featured-imagebox-team style1">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="update/image/junice.jpg" alt="image"> 
                            </div>
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
                                    <h3><a href="https://app.rmiclass.net/users/1058/profile">Junice Y. HOUNGUE</a></h3>
                                </div>
                                <div class="team-position">Coach à la RMI Class</div>
                                <div class="featured-iconbox ttm-media-link">
                                    <div class="media-block">
                                        <div class="media-btn"><i class="ti ti-sharethis"></i></div>
                                        <ul class="social-icons list-inline">
                                            <li class="social-facebook"><a href="https://web.facebook.com/profile.php?id=100007468992835"><i class="ti ti-facebook"></i></a></li>
                                            <li class="social-twitter"><a href="#"><i class="ti ti-twitter-alt"></i></a></li>
                                            <li class="social-instagram"><a href="https://www.instagram.com/junice_houngue?igsh=cmlpMDc2ZzQzeHJl"><i class="ti ti-instagram"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="ttm-box-col-wrapper col-lg-4 col-sm-6 col-md-4 col-xs-12">
                        ...
                        <div class="featured-imagebox featured-imagebox-team style1">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="update/image/fiacre.jpg" alt="image"> 
                            </div>
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
                                    <h3><a href="https://app.rmiclass.net/users/1059/profile">Fiacre KPANOU</a></h3>
                                </div>
                                <div class="team-position">Founder RMI. Trader & Coach</div>
                                <div class="featured-iconbox ttm-media-link">
                                    <div class="media-block">
                                        <div class="media-btn"><i class="ti ti-sharethis"></i></div>
                                        <ul class="social-icons list-inline">
                                            <li class="social-facebook"><a href="https://www.facebook.com/fiacrekpanoud?mibextid=LQQJ4d"><i class="ti ti-facebook"></i></a></li>
                                            <li class="social-twitter"><a href="#"><i class="ti ti-twitter-alt"></i></a></li>
                                            <li class="social-instagram"><a href="https://www.instagram.com/fiacrekpanou?igsh=NzZpN3Nvcm1icG05&utm_source=qr"><i class="ti ti-instagram"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center mt_10">
                                ...
                                <a class="ttm-btn ttm-btn-style-border ttm-icon-btn-right ttm-btn-size-md ttm-btn-color-white" href="#">Rejoignez-nous<i class="flaticon-right-arrow-1"></i></a>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 widget-area">
                            <div class="widget widget_text clearfix">
                                <div class="footer-logo">
                                    <img id="footer-logo-img" class="img-fluid auto_size" alt="image" width="136" height="45" src="update/image/logoblanc.png">
                                </div>
                            ...
                            <div class="widget widget-recent-post clearfix">
                               <h3 class="widget-title">Nos récentes Formation</h3>
                                <ul class="widget-post ttm-recent-post-list pr-5">
                                    <li>
                                        <a href="blog-single.html"><img class="img-fluid" alt="post-img" src="update/image/b1.jpg"></a>
                                        <span class="post-date">12 Juin, 2024</span>
                                        <a href="#">Formation complète en Trading</a>
                                    </li>
                                    <li>
                                        <a href="blog-single.html"><img class="img-fluid" alt="post-img" src="update/image/b2.jpg"></a>
                                        <span class="post-date">28 Juillet, 2024</span>
                                        <a href="#">Devenir Expert Trader. Formation complète</a>
                                    </li>
                                    <li>
                                        <a href="blog-single.html"><img class="img-fluid" alt="post-img" src="update/image/b3.jpg"></a>
