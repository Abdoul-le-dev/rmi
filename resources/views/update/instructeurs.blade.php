            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="ttm-box-col-wrapper col-lg-4 col-sm-6 col-md-4 col-xs-12">
                        ...
                        <div class="featured-imagebox featured-imagebox-team style1">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="images/charbel.jpg" alt="image"> 
                            </div>
                    ...
                    <div class="ttm-box-col-wrapper col-lg-4 col-sm-6 col-md-4 col-xs-12">
                        ...
                        <div class="featured-imagebox featured-imagebox-team style1">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="images/hugues.jpg" alt="image">
                            </div>
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
                    ...
                    <div class="ttm-box-col-wrapper col-lg-4 col-sm-6 col-md-4 col-xs-12">
                        ...
                        <div class="featured-imagebox featured-imagebox-team style1">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="images/junice.jpg" alt="image"> 
                            </div>
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
                    ...
                    <div class="ttm-box-col-wrapper col-lg-4 col-sm-6 col-md-4 col-xs-12">
                        ...
                        <div class="featured-imagebox featured-imagebox-team style1">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="images/fiacre.jpg" alt="image"> 
                            </div>
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
