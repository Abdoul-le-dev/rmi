                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            <div class="page-title-heading">
                                <h2 class="title">La communauté RMI Class</h2>
                            </div>
                            <div class="breadcrumb-wrapper">
                                <span>
                                    <i class="ti ti-home"></i>
                                    <a title="Homepage" href="index.html">Accueil</a>
                                </span>
        ...
        <section class="ttm-row padding_zero-section bg-layer-equal-height clearfix">
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-lg-6">
                        <!-- col-bg-img-four -->
                        <div class="col-bg-img-four ttm-col-bgimage-yes ttm-left-span ttm-bg">
                        ...
                        <img class="img-fluid ttm-equal-height-image" src="https://via.placeholder.com/1200x800?text=1200x800+col-bgimage-4.jpg" alt="bg-image">
                    </div>
                    <div class="col-lg-6">
                        <!-- col-bgcolor-yes-->
                        <div class="ttm-bg ttm-col-bgcolor-yes ttm-right-span ttm-bgcolor-darkgrey col-bg-img-five ttm-col-bgimage-yes spacing-2">
                            <div class="ttm-col-wrapper-bg-layer ttm-bg-layer">
                                <div class="ttm-col-wrapper-bg-layer-inner"></div>
                            </div>
                            <div class="layer-content">
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        <h3>Un apprentissage continu</h3>
                                        <h2 class="title">jusqu'à la réussite<br></h2>
                                    </div>
                                    ...
                                    <div class="timeline">
                                        <div class="timeline-panel">
                                            ...
                                            <div class="timeline-body">
                                                <h3 class="title">Analyse Forex</h3>
                                                <p>Profitez des lives d’analyse (Forex ) : une fois par semaine .</p>
                                            </div>
                                        </div>
                                        <div class="timeline-panel">
                                            <div class="timeline-date">
                                            ...
                                            <div class="timeline-body">
                                                <h3 class="title">Analyse indices</h3>
                                                <p>Profitez des live d’analyse (indices) : une fois par semaine .</p>
                                            </div>
                                        </div>
                                        <div class="timeline-panel">
                                            <div class="timeline-date">
                                            ...
                                            <div class="timeline-body">
                                                ...
                                                <p>Accès à la séance live sur les meilleurs méthodes de gestion risques : 1 fois / semaine.</p>
                                            </div>
                                         ...
                                         <div class="timeline-panel">
                                            ...
                                            <div class="timeline-body">
                                                <h3 class="title">Psychologie du Trader</h3>
                                                <p>Accès à la séance live sur les meilleurs moyens de la gestion des émotions et la psychologie du trader gagnant : 1 fois / semaine </p>
                                            </div>
                                        </div>
                                         ...
                                         <div class="timeline-panel">
                                            ...
                                            <div class="timeline-body">
                                                <h3 class="title">Disponibilité de ressources vidéos</h3>
                                                <p>Possibilité de revisualiser les séances lives à n’importe quel moment.</p>
                                            </div>
                                        </div>
                                         ...
                                         <div class="timeline-panel">
                                            ...
                                            <div class="timeline-body">
                                                <h3 class="title">Setups opportunités</h3>
                                                <p>Profitez permanemment  de nos idées de trade (Setups opportunités).</p>
                                            </div>
                                        </div>
                                         ...
                                         <div class="timeline-panel">
                                            ...
                                            <div class="timeline-body">
                                                <h3 class="title">Interactions</h3>
                                                <p>Interaction et partage d’expériences avec les membres de communauté.</p>
                                            </div>
                                        </div>
                                           ...
                                           <div class="timeline-panel">
                                            ...
                                            <div class="timeline-body">
                                                <h3 class="title">Séances privées</h3>
                                                <p>Possibilité de demander des séances privées ONE To ONE (sur demande).</p>
                                            </div>
                                        </div>
                                            
                                        </div>
                                    </div><!--ttmscore-timeline-round end-->
                                </div>
                            </div>
                        </div>
                    </div>
