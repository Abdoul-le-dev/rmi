            ...
            <div class="container">
                <div class="row pb-70 res-991-pb-0">
                    <div class="col-lg-12">
                        ...
                        <div class="section-title section-title title-style-center_text">
                            <div class="title-header">
                                <h3>LES CONDITIONS D'ACCÈS À LA COMMUNAUTÉ RMI</h3>
                                <h2 class="title">Avoir obligatoirement suivi la <a href="https://app.rmiclass.net/course/devenez-trader-pro">Formation Complète en Trading.</a> pour accéder à la communauté</h2>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-10">
                        ...
                        <div class="featured-icon-box icon-align-before-content">
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3>Devenez Expert Trader</h3>
                                </div>
                                <div class="featured-desc">
                                    <p>Un concept de formation continue pour s'améliorer au quotidien et profiter de partages d'expériences de traders plus expérimentés</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="featured-icon-box icon-align-before-content">
                            ...
                            <div class="featured-content">
                                ...
                                <div class="featured-desc">
                                    <p>Soyez informés de toutes les activités RMI et profitez des opportunités, tendances et astuces de manière journalière .</p>
                                </div>
                            </div>
                        </div>
                        <!-- featured-icon-box end -->
                        ...
                        <div class="featured-icon-box icon-align-before-content ">
                            ...
                            <div class="featured-content">
                                ...
                                <div class="featured-desc">
                                    <p>Une opportunité unique d'avoir un tête-à-tête privé avec un coach. Les challenges n'étant pas les mêmes, individualisez votre formation</p>
                                </div>
                            </div>
                        </div>
                        <!-- featured-icon-box end -->
                    ...
                    <div class="col-lg-6 col-xs-12">
                        <div class="pl-35 res-991-pl-0 res-991-pt-30">
                            <!-- featured-icon-box -->
                            <div class="featured-icon-box icon-align-before-content">
                                <div class="featured-icon">
                                    <div class="ttm-icon ttm-icon_element-border ttm-icon_element-style-round ttm-icon_element-color-skincolor ttm-icon_element-size-md">
                                        <i class="flaticon-idea"></i>
                                    </div>
                                </div>
                                <div class="featured-content">
                                    ...
                                    <div class="featured-title">
                                        <h3>La meilleure plateforme éducative en Afrique francophone</h3>
                                    </div>
                                </div>
                            </div>
                            <!-- featured-icon-box end -->
                            <div class="mt-25 mb-15">
                                <h3 class="fs-22 font-weight-600">Vous avez de bonnes et solides raisons de rejoindre notre communauté!</h3>
                            </div>
                            <p>Notre mission est clair: Vous former à l’excellence. Nous mettons tout en œuvre; notre expérience, nos méthodes nos outils et notre environnement afin d’obtenir de vous, le meilleur trader que vous puissiez devenir.</p>
                            <p>Notre vision est de créer la plus grande communauté de trader rentable qui tire réellement profit du marché, à travers le monde.</p>
                            <div class="d-flex align-items-center pt-10">
                                <div class="pr-20">
                                    <h3 class="fs-22 font-weight-600 mb-0">Fiacre D. KPANOU</h3>
                                    <small>Founder Royal Markets Inv</small>
                                </div>
                                <img class="img-fluid auto_size" src="update/images/sign.png" alt="sign-01">
                            </div>
                        </div>
                    </div>
                </div><!-- row end -->
                            ...
                            <div class="d-lg-flex justify-content-between">
                                <div class="lt-side mb-15 pr-50 res-991-pr-0 res-991-pb-15">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="pl-30">
                                            <h2 class="fs-34 mb-0"><span class="font-weight-normal">Démarrez</span><span class="ttm-textcolor-skincolor font-weight-bold"> La Formation !</span></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="rt-side flex-grow-0 flex-shrink-0 mb-15">
                                    <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-border ttm-btn-color-dark ttm-icon-btn-right" href="https://app.rmiclass.net/course/devenez-trader-pro">Achetez<i class="flaticon-right-arrow-1"></i></a>
                                </div>
                            </div>
                        </div>
                    </div><!-- row end -->
