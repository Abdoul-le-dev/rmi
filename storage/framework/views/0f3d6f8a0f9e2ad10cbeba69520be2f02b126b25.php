            ...
            <li class="sidenav-item <?php echo e((request()->is('panel/webinars') or request()->is('panel/webinars/*')) ? 'sidenav-item-active' : ''); ?>">
                ...
                <div class="collapse <?php echo e((request()->is('panel/webinars') or request()->is('panel/webinars/*')) ? 'show' : ''); ?>" id="webinarCollapse">
                    <ul class="sidenav-item-collapse">
                        ...
                        <li class="mt-5 <?php echo e((request()->is('panel/webinars/recorded')) ? 'active' : ''); ?>">
                            <a href="/panel/webinars/recorded"><?php echo e(trans('panel.recorded_videos')); ?></a>
                        </li>
...
<?php /**PATH D:\RMI Class- AWS\resources\views/web/default/panel/includes/sidebar.blade.php ENDPATH**/ ?>