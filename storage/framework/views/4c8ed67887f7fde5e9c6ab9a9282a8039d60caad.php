                ...
                <form method="get" class="mb-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <!-- Email filter field -->
                                <label class="input-label"><?php echo e(trans('admin/main.email')); ?></label>
                                <input class="form-control" type="text" name="email" id="email" value="<?php echo e(request()->get('email')); ?>" placeholder="Enter email">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <!-- Mobile filter field -->
                                <label class="input-label"><?php echo e(trans('admin/main.mobile')); ?></label>
                                <input class="form-control" type="text" name="mobile" id="mobile" value="<?php echo e(request()->get('mobile')); ?>" placeholder="Enter mobile number">
                            </div>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/rmi/resources/views/admin/users/students.blade.php ENDPATH**/ ?>