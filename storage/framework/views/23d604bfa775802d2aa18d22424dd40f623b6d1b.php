...
<?php $__env->startSection('content'); ?>
    <section>
        <h2 class="section-title"><?php echo e(trans('update.topics_statistics')); ?></h2>
            ...
            <div class="row">
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e($publishedTopics); ?></strong>
                        <span class="font-16 text-gray font-weight-500"><?php echo e(trans('update.published_topics')); ?></span>
                    </div>
                </div>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e($lockedTopics); ?></strong>
                        <span class="font-16 text-gray font-weight-500"><?php echo e(trans('update.locked_topics')); ?></span>
                    </div>
                </div>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e($topicMessages); ?></strong>
                        <span class="font-16 text-gray font-weight-500"><?php echo e(trans('update.topic_messages')); ?></span>
                    </div>
                </div>
    ...
    <section class="mt-25">
        <h2 class="section-title"><?php echo e(trans('update.filter_topics')); ?></h2>
    ...
    <section class="mt-35">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title"><?php echo e(trans('update.my_topics')); ?></h2>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table text-center custom-table">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center"><?php echo e(trans('site.posts')); ?></th>
                                ...
                                <?php $__currentLoopData = $topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-left align-middle">
                                            <div class="user-inline-avatar d-flex align-items-center">
                                                <div class="avatar bg-gray200">
                                                    <img src="<?php echo e($topic->forum->icon); ?>" class="img-cover" alt="">
                                                </div>
                                                <a href="<?php echo e($topic->getPostsUrl()); ?>" target="_blank" class="">
                                                    <div class=" ml-5">
                                                        <span class="d-block font-14 font-weight-500 text-dark-blue"><?php echo e($topic->title); ?></span>
                                                    </div>
                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-center align-middle">
                                            <?php if($topic->close): ?>
                                                <?php echo e(trans('panel.closed')); ?>

                                            <?php else: ?>
                                                <?php echo e(trans('public.published')); ?>
...
<?php echo $__env->make('web.default.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\RMI Class- AWS\resources\views/web/default/panel/forum/topics.blade.php ENDPATH**/ ?>