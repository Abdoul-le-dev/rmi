...
<?php $__env->startSection('content'); ?>
    <section class="">
        ...
        <div class="d-flex align-items-start align-items-md-center flex-column flex-md-row">
            <h1 class="section-title" style="padding-right: 50px;"><?php echo e(trans('panel.dashboard')); ?></h1>

            <!-- Subscription Details -->
            <?php if(!empty($activeSubscribe)): ?>
                <div class="subscription-details text-right" style="display: flex; flex-direction: column; align-items: flex-start; border-left: 4px solid #783bd6; padding-left: 10px;">
                    <div style="font-size: 22px; font-weight: bold; color: #783bd6;">
                        <?php echo e(trans('panel.active_subscription')); ?>:
                        <span style="color: #783bd6; text-transform: uppercase;"><?php echo e($activeSubscribe->title); ?></span>
                    </div>
                    <div style="font-weight: bold; font-size: 22px; color: #000; margin-top: -20px;">
                        <?php echo e(trans('panel.remaining_days')); ?>:
                        <span style="font-weight: bolder; font-size: 40px; padding-left: 15px;">
                            <?php echo e(($activeSubscribe->days - $dayOfUse['days'])); ?> <?php echo e(trans('panel.hours')); ?>

                        </span>
                    </div>
                </div>
                <div style="margin-left: 20px;">
                    <button onclick="window.location.href='/panel/financial/subscribes'" 
                        style="width: 11.5vw; padding: 8px 8px; background-color: #783bd6; color: #fff; font-weight: bold; font-size: 14px; border-radius: 5px; border: none; cursor: pointer;">
                        <?php echo e(trans('panel.renewbtn')); ?>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/rmi/resources/views/web/default/panel/dashboard/index.blade.php ENDPATH**/ ?>