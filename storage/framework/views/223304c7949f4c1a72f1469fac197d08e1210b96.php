...
<div class="container my-5">
    <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
        <h2 class="section-title"><?php echo e(trans('panel.recorded_videos')); ?></h2>
    </div>
...
<script>
    const accessToken = "<?php echo e(env('VIMEO_ACCESS_TOKEN')); ?>"; // Vimeo Access Token
    const vimeoUserId = "<?php echo e(env('VIMEO_USER_ID')); ?>"; // Vimeo User ID
    const folderId = 22674283
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\RMI Class- AWS\resources\views/web/default/panel/webinar/recorded.blade.php ENDPATH**/ ?>