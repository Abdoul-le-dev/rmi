    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (promoEndDate) {
                ...
                if (endDateBenin > new Date().getTime()) {
                    localStorage.removeItem("promo_expired");
                }
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\RMI Class- AWS\resources\views/web/default/course/index.blade.php ENDPATH**/ ?>