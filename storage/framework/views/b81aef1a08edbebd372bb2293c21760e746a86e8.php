                    ...
                    <div class="product-show-info-card bg-info p-15 p-md-25 rounded-lg">
                        ...
                        <div class="product-show-cart-actions d-flex align-items-center flex-wrap ">
                            ...
                            <div class="d-flex flex-column flex-md-row flex-md-wrap align-items-md-center w-100">
                                ...
                                <?php if($productAvailability > 0 and !empty(getFeaturesSettings('direct_products_payment_button_status')) and auth()->check()): ?>
...
<?php echo $__env->make('web.default.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/rmi/resources/views/web/default/products/show.blade.php ENDPATH**/ ?>