<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <?php echo $__env->make("admin/teams/size_bare_add", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
            ...
            <li class="nav-item dropdown <?php echo e((request()->is(getAdminPanelUrl('/financial/purchase-model*', false))) ? 'active' : ''); ?>">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    <i class="fas fa-cart-plus"></i>
                    <span><?php echo e(trans('admin/main.purchase_module')); ?></span>
                </a>
                <ul class="dropdown-menu">
                    <li class="<?php echo e((request()->is(getAdminPanelUrl('/financial/purchase-model', false))) ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/financial/purchase-model"><?php echo e(trans('admin/main.purchase_module')); ?></a>
                    </li>
                    <li class="<?php echo e((request()->is(getAdminPanelUrl('/financial/purchase-model/new', false))) ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/financial/purchase-model/new"><?php echo e(trans('admin/main.new_purchase_module')); ?></a>
                    </li>
                </ul>
            </li>

            <li class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/financial/promo*', false)) ? 'active' : ''); ?>">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    <i class="fa fa-percent"></i>
                    <span><?php echo e(trans('admin/main.promo')); ?></span>
                </a>
                <ul class="dropdown-menu">
                    <li class="<?php echo e(request()->is(getAdminPanelUrl('/financial/promo', false)) ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/financial/promo"><?php echo e(trans('admin/main.list_promo')); ?></a>
                    </li>
                    <li class="<?php echo e(request()->is(getAdminPanelUrl('/financial/promo/new', false)) ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/financial/promo/new"><?php echo e(trans('admin/main.new_promo')); ?></a>
                    </li>
                </ul>
            </li>
...
<?php /**PATH /var/www/rmi/resources/views/admin/includes/sidebar.blade.php ENDPATH**/ ?>