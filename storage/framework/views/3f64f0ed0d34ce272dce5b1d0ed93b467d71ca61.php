...
<?php $__env->startSection('content'); ?>
    <?php if($activeSubscribe): ?>
        <section>
            ...
            <?php if(!empty($promo) && $promo->type == 'Subscription'): ?>
            <div class="promo_div">
                ...
                <div class="row">
                    ...
                    <div class="col-4 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <strong class="font-30 text-dark-blue text-dark-blue font-weight-bold mt-5"><?php echo e(($activeSubscribe->days - $dayOfUse['days'])); ?>:<?php echo e(sprintf('%02d', 24 - $dayOfUse['hours'])); ?></strong>
                    ...
                    <div class="subscribe-plan position-relative bg-white d-flex flex-column align-items-center rounded-sm shadow pt-50 pb-20 px-20">
                            ...
                            <?php if(!empty($subscribe->price) and $subscribe->price > 0): ?>
                                ...
                                <?php if(!empty($promo) && $promo->type == 'Subscription'): ?>
                                    <div class="d-flex align-items-end line-height-1">
                                        <span class="font-36 text-primary"><?php echo e(handlePrice($discountedPrice, true, true, false, null, true)); ?></span>
                                        <span class="font-14 text-danger ml-5 text-decoration-line-through"><?php echo e(handlePrice($subscribe->price, true, true, false, null, true)); ?></span>
                                    </div>
                                <?php elseif(!empty($subscribeSpecialOffer)): ?>
                                    <div class="d-flex align-items-end line-height-1">
                        ...
                        <ul class="mt-20 plan-feature">
                            ...
                            <li class="mt-10">
                                ...
                                <?php echo e(trans('update.unlimited')); ?> <span class="ml-5"><?php echo e(trans('update.access')); ?></span>
                            </li>
                            <li class="mt-10"><?php echo e(trans('new_translations.live_class')); ?></li>
                            <li class="mt-10"><?php echo e(trans('new_translations.opportunity_setups')); ?></li>
                            <li class="mt-10"><?php echo e(trans('new_translations.interaction_community')); ?></li>
                            <li class="mt-10"><?php echo e(trans('new_translations.access_to_our_tools_indicators_templates')); ?></li>
                        </ul>
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const endDate = new Date("<?php echo e($promo->end_date ?? now()); ?>").getTime();
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/rmi/resources/views/web/default/panel/financial/subscribes.blade.php ENDPATH**/ ?>