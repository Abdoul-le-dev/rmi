(() => {
    ...
    !(function (e) {
        e("body").on("click", ".panel-file-manager", function (t) {
            t.preventDefault(),
                e(this).filemanager("file", { prefix: "/laravel-filemanager" });
        });
        var n = e("#learningPageContent");
        function a(t, a) {
            var s = { type: a, id: t };
            e.post("/course/learning/itemInfo", s, function (t) {
                if ("session" === a) {
                    var s = t.session;
                    s &&
                        (s.is_finished
                            ? (function (t) {
                                  var e = sessionIsFinishedLang,
                                      a = sessionIsFinishedHintLang,
                                      s = "live_session.svg",
                                      r = '\n                <a href="'
                                          .concat(
                                              courseUrl,
                                              '" class="btn btn-white btn-sm mt-15">'
                                          )
                                          .concat(
                                              coursePageLang,
                                              "</a>\n        "
                                      ...
                                      c = i(e, a, s, r, "mt-10");
                                  (c += o(t)), n.html(c), feather.replace();
                              })(s)
                            : s.is_started
                            ? (function (t) {
                                  var e = sessionIsLiveLang,
                                      a = youCanJoinTheLiveNowLang,
                                      s = "live_session.svg",
                                      r = "";
                                  t.password &&
                                      (r +=
                                  ...
                                  r +=
                                      '\n            <div class="d-flex align-items-center mt-15">\n                <a href="'
                                          ...
                                          .concat(
                                              courseUrl,
                                              '" class="btn btn-white btn-sm ml-10">'
                                          )
                                          .concat(
                                              coursePageLang,
                                              "</a>\n            </div>\n        "
                                          );
                                  var c = i(e, a, s, r, "mt-10");
                                  (c += o(t)), n.html(c), feather.replace();
                              })(s)
                            : (function (t) {
                                  var e = sessionIsNotStartedYetLang,
                                      a =
                                          thisSessionWillBeStartedOnLang +
                                          " " +
                                          t.start_data,
                                      s = "live_session.svg",
                                      r =
                    ...
                    "file" === a
                        ? (function (t) {
                              if (
                                  (t.online_viewer &&
                                      "0" !== t.online_viewer) ||
                                  (t.downloadable && "0" !== t.downloadable)
                              ) {
                                  if (
                                      t.online_viewer &&
                                      "0" !== t.online_viewer
                                      ...
                                      var a =
                                          '<div class="d-flex flex-column p-10 h-100">';
                                      (a += '<iframe src="/ViewerJS/index.html#'
                                          .concat(
                                              t.file_path,
                        ...
                        ? (function (t) {
                              ...
                              t.attachments &&
                                  ...
                                  Object.keys(t.attachments).forEach(function (
                                      n
                                  ) {
                                      var a = t.attachments[n];
                                      e +=
                                  ...
                                  (e += "</div>\n                </div>"));
                              (e += o(t)), n.html(e), feather.replace();
                          })(t.textLesson)
                        : "quiz" === a &&
                          (function (t) {
                              var e = t.title,
                                  a = goToTheQuizPageForMoreInformationLang,
                                  s = "quiz.svg",
                                  r = "";
                              t.has_expired
                                  ? ((e = expiredQuizLang),
                                    (a = t.expired_message))
                                  : (t.expire_time_message &&
                                        "null" !== t.expire_time_message &&
                                        (r +=
                                            '<div class="mt-10 font-14 text-gray">'.concat(
                                                t.expire_time_message,
                                                "</div>"
                                            )),
                                    t.can_try
        ...
        function o(t) {
            return "1" === courseNotesStatus
                ? '<div class="js-personal-notes-form learning-page-personal-note bg-white mt-15 p-10 rounded-sm" data-item-id="'
                      .concat(t.id, '" data-item-type="')
                      .concat(t.modelName, '" data-course-id="')
                      .concat(
                          t.webinar_id,
                      ...
                      .concat(
                          t.personalNote && t.personalNote.note
                              ? t.personalNote.note
                              : "",
                          "</textarea>\n\n                "
                      )
        ...
        document.addEventListener(
            ...
            e(document).ready(function () {
                ...
                if (
                    ...
                    try {
                        for (s.s(); !(i = s.n()).done; ) {
                            var r = i.value,
                                ...
                                l = c.attr("data-type"),
                                d = c.attr("data-id");
                            if (l === defaultItemType && d === defaultItemId) {
                                c.trigger("click");
                                var f = c.closest(".collapse");
                                f && f.collapse("show");
                            }
                        }
                    } catch (t) {
                    ...
                    o &&
                    loadFirstContent &&
                    "false" !== loadFirstContent
                )
                    if (o.length) {
                        var g = o[0],
                            m = e(g);
                        m.trigger("click");
                        var u = m.closest(".collapse");
                        u && u.collapse("show");
                    } else
                        (a =
            ...
            e("body").on("click", "#collapseBtn", function () {
                e(".learning-page-tabs").toggleClass("show");
            }),
            e(window).width() < 992 &&
                e(".learning-page-tabs").removeClass("show"),
            e("body").on("click", ".nav-item a", function () {
                var t = e(".learning-page-tabs");
                t.hasClass("show") || t.addClass("show");
            }),
            e("body").on("click", ".tab-item", function () {
                var t = e(this);
                if (!t.hasClass("active")) {
                    var n = t.attr("data-type"),
                        o = t.attr("data-id");
                    e(".tab-item-info").slideUp(),
                        e(".tab-item").removeClass("active"),
                        e(".certificate-item").removeClass("active"),
                        t.addClass("active"),
                        t.find(".tab-item-info").slideDown(),
                        e(window).width() < 992 &&
                            e(".learning-page-tabs").removeClass("show"),
                        "assignment" !== n && (s(), a(o, n));
                }
            }),
            e("body").on("click", "#checkAgainSession", function () {
                var t = e(this),
                    n = t.attr("data-type"),
                    o = t.attr("data-id");
                s(), a(o, n);
            }),
            e("body").on("click", ".certificate-item", function () {
                var t = e(this);
                e(".course-certificate-item").removeClass("active"),
                    e(".certificate-item").removeClass("active"),
                    e(".tab-item").removeClass("active"),
                    t.addClass("active"),
                    (function (t) {
                        var e = downloadCertificateLang,
                            a = enjoySharingYourCertificateWithOthersLang,
                            o = "quiz.svg",
                            s = "";
                        s =
                            t && "" !== t
            ...
            e("body").on("click", ".course-certificate-item", function () {
                var t = e(this);
                e(".course-certificate-item").removeClass("active"),
                    e(".certificate-item").removeClass("active"),
                    e(".tab-item").removeClass("active"),
                    ...
                    (function (t) {
                        ...
                        var r = i(e, a, o, s);
                        n.html(r);
                    })(t.attr("data-course-certificate"));
            }),
            e("body").on("change", ".js-passed-lesson-toggle", function (t) {
                var n = e(this),
                    a = n.val(),
                    o = n.attr("data-item"),
                    i = n.attr("data-item-id"),
                    s = this.checked,
                    r = { item: o, item_id: i, status: s };
                e.post("/course/" + a + "/learningStatus", r, function (t) {
                    e.toast({
                        heading: "",
            ...
            e("body").on(
                ...
                function (t) {
                    t.preventDefault();
                    var n = e(this).attr("data-passed-error"),
                        a = e(this).attr("data-access-days-error"),
                        o = '<ul class="list-group-custom">\n';
            ...
            e("body").on("click", ".js-save-history-message", function () {
                var t = e(this),
                    n = t.closest("form"),
                    a = n.attr("action"),
                    o = n.serializeObject();
                t.addClass("loadingbar primary").prop("disabled", !0),
                    ...
                    e
                        ...
                        .fail(function (e) {
                            t.removeClass("loadingbar primary").prop(
                                "disabled",
                                !1
                            );
            ...
            e("body").on("click", ".js-save-history-rate", function () {
                var t = e(this),
                    n = t.closest("form"),
                    a = n.attr("action"),
                    o = n.serializeObject();
            ...
            e("body").on("click", ".js-not-access-toast", function (t) {
                t.preventDefault(),
                    notAccessToastTitleLang &&
                        notAccessToastMsgLang &&
                        r(notAccessToastTitleLang, notAccessToastMsgLang);
            }),
            e("body").on("click", ".js-cant-start-quiz-toast", function (t) {
                t.preventDefault(),
            ...
            e("body").on("click", ".js-save-personal-note", function (t) {
                t.preventDefault();
                var n = e(this),
                    a = n.closest(".js-personal-notes-form"),
                    o = {
                        course_id: a.attr("data-course-id"),
                        item_id: a.attr("data-item-id"),
                        item_type: a.attr("data-item-type"),
                        note: a.find('textarea[name="notes"]').val(),
                        attachment: a.find('input[name="attach"]').val(),
                    };
                n.addClass("loadingbar primary").prop("disabled", !0),
                    e
                        .post(
                            "/course/learning/personalNotes",
                            o,
                            function (t) {
                                t &&
                                    200 === t.code &&
            ...
            e("body").on("click", ".js-clear-personal-note", function (t) {
                t.preventDefault();
                var n = e(this).closest(".js-personal-notes-form");
                n.find('textarea[name="notes"]').val(""),
                    n.find('input[name="attach"]').val("");
            });
    })(jQuery);
})();
