...
(function ($) {
    ...
    window.resetDatePickers = () => {
        if (jQuery().daterangepicker) {
            ...
            const format1 =
                $dateRangePicker.attr("data-format") ?? "YYYY-MM-DD";
            ...
            $dateRangePicker.on("apply.daterangepicker", function (ev, picker) {
                $(this).val(
                    picker.startDate.format(format1) +
                        " - " +
                        picker.endDate.format(format1)
                );
            });
            ...
            const format2 =
                $datetimepicker.attr("data-format") ?? "YYYY-MM-DD HH:mm";
    ...
    $(document).ready(function () {
        ...
        handleSearchableSelect2(
            "search-user-select22",
            adminPanelPrefix + "/users/search",
            "name"
        );

        handleSearchableSelect2(
            "search-webinar-select2",
            adminPanelPrefix + "/webinars/search",
            "title"
        );

        handleSearchableSelect2(
            "search-bundle-select2",
            adminPanelPrefix + "/bundles/search",
            "title"
        );

        handleSearchableSelect2(
            "search-forum-topic-select2",
            adminPanelPrefix + "/forums/topics/search",
            "title"
        );

        handleSearchableSelect2(
            "search-product-select2",
            adminPanelPrefix + "/store/products/search",
            "title"
        );

        handleSearchableSelect2(
            "search-category-select2",
            adminPanelPrefix + "/categories/search",
            "title"
        );

        handleSearchableSelect2(
            "search-blog-select2",
            adminPanelPrefix + "/blog/search",
            "title"
        );

        handleSearchableSelect2(
            "search-upcoming-course-select2",
            adminPanelPrefix + "/upcoming_courses/search",
            "title"
        );
        ...
        if (
            typeof sidebar_nicescroll !== "undefined" &&
            sidebar_nicescroll.length
        ) {
    ...
    if ($colorpickerinput.length) {
        var colorpickerinputFormat =
            $colorpickerinput.attr("data-format") ?? "hex";
