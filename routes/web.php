...
Route::group(['namespace' => 'Auth', 'middleware' => ['share', 'check_maintenance', 'check_restriction', 'capture.intended']], function () {
...
Route::group(['namespace' => 'Web', 'middleware' => ['check_mobile_app', 'impersonate', 'share', 'check_maintenance', 'check_restriction', 'capture.intended']], function () {
    ...
    Route::group(['prefix' => 'course'], function () {
        ...
        Route::group(['middleware' => 'web.auth'], function () {
            ...
            Route::post('/pay-purchasemodel', 'WebinarController@purchaseModelPay');
        });
    });
    ...
    Route::group(['prefix' => 'categories', 'middleware' => 'check.subscription'], function () {
    ...
    Route::group(['prefix' => 'instructors', 'middleware' => 'check.subscription'], function () {
...
Route::get('/media/temp-url/{path}', [MediaController::class, 'preview'])
    ->where('path', '.*')
    ->name('media.preview');
