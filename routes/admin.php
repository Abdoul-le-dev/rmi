...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => ['web', 'admin_locale']], function () use ($prefix) {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'suscriber'], function () {
            ...
            Route::get('/test', 'DashboardController@suscriber_search');
        ...
        Route::group(['prefix' => 'financial'], function () {
            ...
            Route::group(['prefix' => 'purchase-model'], function () {
                Route::get('/', 'PurchaseModuleController@index');
                Route::get('/new', 'PurchaseModuleController@create');
                Route::post('/store', 'PurchaseModuleController@store');
                Route::get('/{id}/edit', 'PurchaseModuleController@edit');
                Route::post('/{id}/update', 'PurchaseModuleController@update');
                Route::get('/{id}/delete', 'PurchaseModuleController@delete');
            });

            Route::group(['prefix' => 'promo'], function () {
                Route::get('/', 'PromoController@index');
                Route::get('/new', 'PromoController@create');
                Route::post('/store', 'PromoController@store');
                Route::get('/{id}/edit', 'PromoController@edit');
                Route::post('/{id}/update', 'PromoController@update');
                Route::get('/{id}/delete', 'PromoController@delete');
            });
