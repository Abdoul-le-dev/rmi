...
Route::group(['namespace' => 'Panel', 'prefix' => 'panel', 'middleware' => ['impersonate', 'panel', 'share', 'check_maintenance', 'check_restriction']], function () {
    ...
    Route::group(['prefix' => 'webinars'], function () {
        ...
        Route::group(['prefix' => 'recorded', 'middleware' => 'check.subscription'], function () {
            Route::get('/', 'RecordedController@index');
        });
    ...
    Route::group(['prefix' => 'sessions'], function () {
        ...
        // Route::get('/generate-signature', 'SessionController@generateSignature')->name('generateSignature');
        // Route::get('/{id}/class', 'SessionController@viewZoom')->name('zoom.view');
    });

    // Route::namespace('Web')->group(function () {
    //     Route::get('/generate-signature', 'ZoomController@generateSignature')->name('generateSignature');
    //     Route::get('/zoom', 'ZoomController@viewZoom')->name('zoom.view');
    //     Route::get('/zoom-create-meeting', 'ZoomController@createMeeting')->name('zoom.create.meeting');
    //     Route::get('/revoke', 'ZoomController@revokeAccessToken')->name('zoom.accesstoken.revoke');
    //     Route::get('/get-zak', 'ZoomController@getZakToken')->name('getZakToken');
    //     Route::get('/zoomuser', 'ZoomController@validateMeetingHost')->name('zoom.oauth.user'); // Redirect to Zoom OAuth
    // });
