...
class LoginController extends Controller
{
    ...
    */
    ...
    public function logout(Request $request)
    {
        ...
        // return redirect()->away('https://testingfront.rmiclass.net/');
    }
    ...
    public function username()
    {
        ...
        if (empty($this->username)) {
            ...
            if (preg_match($email_regex, request('email', null))) {
                $this->username = 'email';
            }
        }
    ...
    public function afterLogged(Request $request, $verify = false)
    {
        ...
        if ($user->status != User::$active and !$verify) {
            ...
            $checkConfirmed = $verificationController->checkConfirmed($user, $this->username(), $request->get('email'));
