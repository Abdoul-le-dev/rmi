...
class PaymentController extends Controller
{
    ...
    {
        // Log::info('Here in payment request');
    ...
    {
        // Log::info('Here inside PaymentVerify');
        ...
        try {
            ...
            Log::info('Error in paymentVerify',['msg'=>$exception->getMessage()]);
    ...
    {
        // Log::info('Here inside paymentOrderAfterVerify');
        if (!empty($order)) {
    ...
    {
        // Log::info('Here inside setPaymentAccounting');
        ...
        if ($order->is_charge_account) {
            ...
            foreach ($order->orderItems as $orderItem) {
                ...
                // Log::info('Sales inserted');

                if (!empty($orderItem->reserve_meeting_id)) {
                    // Log::info('Here inside reserve_meeting_id');
                    $reserveMeeting = ReserveMeeting::where('id', $orderItem->reserve_meeting_id)->first();
                ...
                if (!empty($orderItem->subscribe_id)) {
                    // Log::info('Here inside $orderItem->subscribe_id');
                    ...
                    // Log::info('Here inside last else statement');
                    Accounting::createAccounting($orderItem, $type);
                    // Log::info('Logging after Accounting::createAccounting');
